...
- The claim "no internet permission" must be re-verified against the shipping manifest in phase 40. It is true of every spike today.
- The section on storage lists what production will store. Only temporary openings exist so far, in spike `A-04`. The wording is written for the shipping product because that is what the policy will accompany; phase 40 must confirm it still matches.
