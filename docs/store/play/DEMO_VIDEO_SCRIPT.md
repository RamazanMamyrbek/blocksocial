...
The spike has no disclosure screen. Film this against a static render of the approved copy and say so in the description, or defer this shot until phase 19 builds the real screen. Do not film a mockup and present it as the running app.
