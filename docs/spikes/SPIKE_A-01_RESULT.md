...
- No reboot, no permission revocation, no long-running or low-memory behaviour was tested. Those belong to phases 04 and 20.
...
Physical-device confirmation of these eight scenarios remains required and is carried by the Android beta, phase 24.
...
| 3 | Unlocking into an open target produces no detection | **open**, assigned to phase 12 |
